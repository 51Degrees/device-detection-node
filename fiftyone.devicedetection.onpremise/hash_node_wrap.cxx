...
#define SWIGTYPE_p_ResultsHashSerializer swig_types[22]
#define SWIGTYPE_p_Transform swig_types[23]
#define SWIGTYPE_p_ValueMetaData swig_types[24]
#define SWIGTYPE_p_ValueMetaDataKey swig_types[25]
#define SWIGTYPE_p_ValueT_bool_t swig_types[26]
#define SWIGTYPE_p_ValueT_double_t swig_types[27]
#define SWIGTYPE_p_ValueT_int_t swig_types[28]
#define SWIGTYPE_p_ValueT_std__string_t swig_types[29]
#define SWIGTYPE_p_ValueT_std__vectorT_std__string_t_t swig_types[30]
...
#define SWIGTYPE_p_std__vectorT_uint8_t_t swig_types[43]
...
SWIGINTERN std::vector< std::string >::value_type const &std_vector_Sl_std_string_Sg__get(std::vector< std::string > *self,int i){
...
SWIGINTERN std::vector< unsigned char >::value_type const &std_vector_Sl_uint8_t_Sg__get(std::vector< uint8_t > *self,int i){
                int size = int(self->size());
                if (i>=0 && i<size)
                    return (*self)[i];
                else
...
SWIGV8_ClientData _exports_UTF8StringSwig_clientData;
...
SWIGV8_ClientData _exports_ResultsHashSerializer_clientData;
SWIGV8_ClientData _exports_Transform_clientData;
...
static SwigV8ReturnValue _wrap_new_MapStringStringSwig__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_MapStringStringSwig__SWIG_0.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_MapStringStringSwig__SWIG_0.");
...
static SwigV8ReturnValue _wrap_new_MapStringStringSwig__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  int res1 = 0 ;
  std::map< std::string,std::string > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_MapStringStringSwig__SWIG_1.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_MapStringStringSwig__SWIG_1.");
  ...
  if (!argp1) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_MapStringStringSwig" "', argument " "1"" of type '" "std::map< std::string,std::string > const &""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::string > * >(argp1);result = (std::map< std::string,std::string > *)new std::map< std::string,std::string >((std::map< std::string,std::string > const &)*arg1);
...
static SwigV8ReturnValue _wrap_MapStringStringSwig_size(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MapStringStringSwig_size.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__mapT_std__string_std__string_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< std::map< std::string,std::string > * >(argp1);result = (unsigned int)((std::map< std::string,std::string > const *)arg1)->size();
...
static SwigV8ReturnValue _wrap_MapStringStringSwig_empty(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MapStringStringSwig_empty.");
  ...
  arg1 = reinterpret_cast< std::map< std::string,std::string > * >(argp1);result = (bool)((std::map< std::string,std::string > const *)arg1)->empty();
...
static SwigV8ReturnValue _wrap_MapStringStringSwig_clear(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MapStringStringSwig_clear.");
  ...
  arg1 = reinterpret_cast< std::map< std::string,std::string > * >(argp1);(arg1)->clear();
...
static SwigV8ReturnValue _wrap_MapStringStringSwig_get(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MapStringStringSwig_get.");
  ...
  arg1 = reinterpret_cast< std::map< std::string,std::string > * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "MapStringStringSwig_get" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_MapStringStringSwig_set(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 2 || args.Length() > 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MapStringStringSwig_set.");
  ...
  arg1 = reinterpret_cast< std::map< std::string,std::string > * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "MapStringStringSwig_set" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
  {
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "MapStringStringSwig_set" "', argument " "3"" of type '" "std::string const &""'"); 
      }
      arg3 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_MapStringStringSwig_del(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MapStringStringSwig_del.");
  ...
  arg1 = reinterpret_cast< std::map< std::string,std::string > * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "MapStringStringSwig_del" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_MapStringStringSwig_has_key(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MapStringStringSwig_has_key.");
  ...
  arg1 = reinterpret_cast< std::map< std::string,std::string > * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "MapStringStringSwig_has_key" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_new_VectorStringSwig__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_VectorStringSwig__SWIG_0.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_VectorStringSwig__SWIG_0.");
...
static SwigV8ReturnValue _wrap_new_VectorStringSwig__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  int ecode1 = 0 ;
  std::vector< std::string > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_VectorStringSwig__SWIG_1.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_VectorStringSwig__SWIG_1.");
...
static SwigV8ReturnValue _wrap_new_VectorStringSwig__SWIG_2(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  int res1 = 0 ;
  std::vector< std::string > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_VectorStringSwig__SWIG_2.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_VectorStringSwig__SWIG_2.");
  ...
  if (!argp1) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_VectorStringSwig" "', argument " "1"" of type '" "std::vector< std::string > const &""'"); 
  }
...
static SwigV8ReturnValue _wrap_VectorStringSwig_size(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringSwig_size.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_std__string_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_VectorStringSwig_capacity(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringSwig_capacity.");
...
static SwigV8ReturnValue _wrap_VectorStringSwig_reserve(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringSwig_reserve.");
  ...
  arg2 = static_cast< std::vector< std::string >::size_type >(val2);(arg1)->reserve(SWIG_STD_MOVE(*(&arg2)));
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_VectorStringSwig_isEmpty(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringSwig_isEmpty.");
...
static SwigV8ReturnValue _wrap_VectorStringSwig_clear(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringSwig_clear.");
...
static SwigV8ReturnValue _wrap_VectorStringSwig_add(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringSwig_add.");
  ...
  arg1 = reinterpret_cast< std::vector< std::string > * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "VectorStringSwig_add" "', argument " "2"" of type '" "std::vector< std::string >::value_type const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_VectorStringSwig_get(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringSwig_get.");
...
static SwigV8ReturnValue _wrap_VectorStringSwig_set(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 2 || args.Length() > 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringSwig_set.");
  ...
  arg2 = static_cast< int >(val2);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "VectorStringSwig_set" "', argument " "3"" of type '" "std::vector< std::string >::value_type const &""'"); 
      }
      arg3 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_new_RequiredPropertiesConfigSwig__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_RequiredPropertiesConfigSwig__SWIG_0.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_RequiredPropertiesConfigSwig__SWIG_0.");
  {
    try {
...
static SwigV8ReturnValue _wrap_new_RequiredPropertiesConfigSwig__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  int res1 = 0 ;
  RequiredPropertiesConfig *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_RequiredPropertiesConfigSwig__SWIG_1.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_RequiredPropertiesConfigSwig__SWIG_1.");
...
static SwigV8ReturnValue _wrap_new_RequiredPropertiesConfigSwig__SWIG_2(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  int alloc1 = 0 ;
  RequiredPropertiesConfig *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_RequiredPropertiesConfigSwig__SWIG_2.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_RequiredPropertiesConfigSwig__SWIG_2.");
...
static SwigV8ReturnValue _wrap_RequiredPropertiesConfigSwig_getProperties(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_RequiredPropertiesConfigSwig_getProperties.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_RequiredPropertiesConfig, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_new_StringValueSwig(const SwigV8Arguments &args) {
  ...
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_StringValueSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_StringValueSwig.");
  {
    try {
...
static SwigV8ReturnValue _wrap_StringValueSwig_hasValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_StringValueSwig_hasValue.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ValueT_std__string_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_StringValueSwig_getNoValueMessage(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_StringValueSwig_getNoValueMessage.");
...
static SwigV8ReturnValue _wrap_StringValueSwig_getValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_StringValueSwig_getValue.");
...
static SwigV8ReturnValue _wrap_new_BoolValueSwig(const SwigV8Arguments &args) {
  ...
  SWIGV8_OBJECT self = args.This();
  Value< bool > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_BoolValueSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_BoolValueSwig.");
  {
    try {
...
static SwigV8ReturnValue _wrap_BoolValueSwig_hasValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_BoolValueSwig_hasValue.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ValueT_bool_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_BoolValueSwig_getNoValueMessage(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_BoolValueSwig_getNoValueMessage.");
...
static SwigV8ReturnValue _wrap_BoolValueSwig_getValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_BoolValueSwig_getValue.");
...
static SwigV8ReturnValue _wrap_new_IntegerValueSwig(const SwigV8Arguments &args) {
  ...
  SWIGV8_OBJECT self = args.This();
  Value< int > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_IntegerValueSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_IntegerValueSwig.");
  {
    try {
...
static SwigV8ReturnValue _wrap_IntegerValueSwig_hasValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_IntegerValueSwig_hasValue.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ValueT_int_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_IntegerValueSwig_getNoValueMessage(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_IntegerValueSwig_getNoValueMessage.");
...
static SwigV8ReturnValue _wrap_IntegerValueSwig_getValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_IntegerValueSwig_getValue.");
...
static SwigV8ReturnValue _wrap_new_VectorStringValuesSwig(const SwigV8Arguments &args) {
  ...
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_VectorStringValuesSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_VectorStringValuesSwig.");
  {
    try {
...
static SwigV8ReturnValue _wrap_VectorStringValuesSwig_hasValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringValuesSwig_hasValue.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ValueT_std__vectorT_std__string_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_VectorStringValuesSwig_getNoValueMessage(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringValuesSwig_getNoValueMessage.");
...
static SwigV8ReturnValue _wrap_VectorStringValuesSwig_getValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_VectorStringValuesSwig_getValue.");
...
static SwigV8ReturnValue _wrap_new_DoubleValueSwig(const SwigV8Arguments &args) {
  ...
  SWIGV8_OBJECT self = args.This();
  Value< double > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_DoubleValueSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_DoubleValueSwig.");
  {
    try {
...
static SwigV8ReturnValue _wrap_DoubleValueSwig_hasValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_DoubleValueSwig_hasValue.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ValueT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_DoubleValueSwig_getNoValueMessage(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_DoubleValueSwig_getNoValueMessage.");
...
static SwigV8ReturnValue _wrap_DoubleValueSwig_getValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_DoubleValueSwig_getValue.");
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_getAvailableProperties(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsBaseSwig_getAvailableProperties.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ResultsBase, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_containsProperty(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsBaseSwig_containsProperty.");
  ...
  arg1 = reinterpret_cast< ResultsBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ResultsBaseSwig_containsProperty" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_getProperties(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsBaseSwig_getProperties.");
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_getPropertyName(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsBaseSwig_getPropertyName.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ResultsBase, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ResultsBaseSwig_getPropertyName" "', argument " "1"" of type '" "ResultsBase *""'"); 
  }
  arg1 = reinterpret_cast< ResultsBase * >(argp1);ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_getValues__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< ResultsBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ResultsBaseSwig_getValues" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
  ...
  jsresult = SWIG_NewPointerObj((new Value< std::vector< std::string > >(result)), SWIGTYPE_p_ValueT_std__vectorT_std__string_t_t, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_getValueAsString__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< ResultsBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ResultsBaseSwig_getValueAsString" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
  ...
  jsresult = SWIG_NewPointerObj((new Value< std::string >(result)), SWIGTYPE_p_ValueT_std__string_t, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_getValueAsBool__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< ResultsBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ResultsBaseSwig_getValueAsBool" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
  ...
  jsresult = SWIG_NewPointerObj((new Value< bool >(result)), SWIGTYPE_p_ValueT_bool_t, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_getValueAsInteger__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< ResultsBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ResultsBaseSwig_getValueAsInteger" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
  ...
  jsresult = SWIG_NewPointerObj((new Value< int >(result)), SWIGTYPE_p_ValueT_int_t, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_ResultsBaseSwig_getValueAsDouble__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< ResultsBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ResultsBaseSwig_getValueAsDouble" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
  ...
  jsresult = SWIG_NewPointerObj((new Value< double >(result)), SWIGTYPE_p_ValueT_double_t, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_Date_getYear(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Date_getYear.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_Date, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_Date_getMonth(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Date_getMonth.");
...
static SwigV8ReturnValue _wrap_Date_getDay(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Date_getDay.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getName(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getName.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_PropertyMetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getDataFilesWherePresent(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getDataFilesWherePresent.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getType(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getType.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getCategory(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getCategory.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getUrl(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getUrl.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getAvailable(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getAvailable.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getDisplayOrder(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getDisplayOrder.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getIsMandatory(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getIsMandatory.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getIsList(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getIsList.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getIsObsolete(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getIsObsolete.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getShow(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getShow.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getShowValues(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getShowValues.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataSwig_getDescription(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataSwig_getDescription.");
...
static SwigV8ReturnValue _wrap_ComponentMetaDataSwig_getComponentIdAsInt(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ComponentMetaDataSwig_getComponentIdAsInt.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ComponentMetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_ComponentMetaDataSwig_getComponentId(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ComponentMetaDataSwig_getComponentId.");
  ...
  jsresult = SWIG_NewPointerObj((new byte(result)), SWIGTYPE_p_byte, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_ComponentMetaDataSwig_getName(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ComponentMetaDataSwig_getName.");
...
static SwigV8ReturnValue _wrap_ProfileMetaDataSwig_getProfileId(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ProfileMetaDataSwig_getProfileId.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ProfileMetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_new_UTF8StringSwig__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.This();
  std::vector< uint8_t > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_UTF8StringSwig__SWIG_0.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_UTF8StringSwig__SWIG_0.");
  {
    try {
  ...
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_std__vectorT_uint8_t_t, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_new_UTF8StringSwig__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  ...
  int ecode1 = 0 ;
  std::vector< uint8_t > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_UTF8StringSwig__SWIG_1.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_UTF8StringSwig__SWIG_1.");
  ecode1 = SWIG_AsVal_size_t(args[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_UTF8StringSwig" "', argument " "1"" of type '" "std::vector< unsigned char >::size_type""'");
  } 
  arg1 = static_cast< std::vector< unsigned char >::size_type >(val1);{
    try {
      result = (std::vector< uint8_t > *)new std::vector< uint8_t >(SWIG_STD_MOVE(*(&arg1)));;
    }
    catch(FatalException& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
...
static SwigV8ReturnValue _wrap_new_UTF8StringSwig__SWIG_2(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  ...
  int res1 = 0 ;
  std::vector< uint8_t > *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_UTF8StringSwig__SWIG_2.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_UTF8StringSwig__SWIG_2.");
  res1 = SWIG_ConvertPtr(args[0], &argp1, SWIGTYPE_p_std__vectorT_uint8_t_t,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_UTF8StringSwig" "', argument " "1"" of type '" "std::vector< uint8_t > const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_UTF8StringSwig" "', argument " "1"" of type '" "std::vector< uint8_t > const &""'"); 
  }
...
static SwigV8ReturnValue _wrap_new_UTF8StringSwig(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() == 0) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_UTF8StringSwig__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_UTF8StringSwig__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_UTF8StringSwig__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_UTF8StringSwig__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_UTF8StringSwig__SWIG_2(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_UTF8StringSwig__SWIG_2(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  // default:
  SWIG_exception_fail(SWIG_ERROR, "Illegal arguments for construction of _exports_UTF8StringSwig");
...
static SwigV8ReturnValue _wrap_UTF8StringSwig_size(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UTF8StringSwig_size.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UTF8StringSwig_size" "', argument " "1"" of type '" "std::vector< uint8_t > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< uint8_t > * >(argp1);{
    try {
...
static SwigV8ReturnValue _wrap_UTF8StringSwig_capacity(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UTF8StringSwig_capacity.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UTF8StringSwig_capacity" "', argument " "1"" of type '" "std::vector< uint8_t > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< uint8_t > * >(argp1);{
    try {
...
static SwigV8ReturnValue _wrap_UTF8StringSwig_reserve(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UTF8StringSwig_reserve.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UTF8StringSwig_reserve" "', argument " "1"" of type '" "std::vector< uint8_t > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< uint8_t > * >(argp1);ecode2 = SWIG_AsVal_size_t(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "UTF8StringSwig_reserve" "', argument " "2"" of type '" "std::vector< unsigned char >::size_type""'");
  } 
...
static SwigV8ReturnValue _wrap_UTF8StringSwig_isEmpty(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UTF8StringSwig_isEmpty.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UTF8StringSwig_isEmpty" "', argument " "1"" of type '" "std::vector< uint8_t > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< uint8_t > * >(argp1);{
    try {
...
static SwigV8ReturnValue _wrap_UTF8StringSwig_clear(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UTF8StringSwig_clear.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UTF8StringSwig_clear" "', argument " "1"" of type '" "std::vector< uint8_t > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< uint8_t > * >(argp1);{
    try {
      (arg1)->clear();;
...
static SwigV8ReturnValue _wrap_UTF8StringSwig_add(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UTF8StringSwig_add.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UTF8StringSwig_add" "', argument " "1"" of type '" "std::vector< uint8_t > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< uint8_t > * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_char(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "UTF8StringSwig_add" "', argument " "2"" of type '" "std::vector< unsigned char >::value_type""'");
  } 
...
static SwigV8ReturnValue _wrap_UTF8StringSwig_get(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UTF8StringSwig_get.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UTF8StringSwig_get" "', argument " "1"" of type '" "std::vector< uint8_t > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< uint8_t > * >(argp1);ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "UTF8StringSwig_get" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);{
    try {
      try {
...
static SwigV8ReturnValue _wrap_UTF8StringSwig_set(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 2 || args.Length() > 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_UTF8StringSwig_set.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UTF8StringSwig_set" "', argument " "1"" of type '" "std::vector< uint8_t > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< uint8_t > * >(argp1);ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "UTF8StringSwig_set" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);ecode3 = SWIG_AsVal_unsigned_SS_char(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "UTF8StringSwig_set" "', argument " "3"" of type '" "std::vector< unsigned char >::value_type""'");
  } 
...
static void _wrap_delete_UTF8StringSwig(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
...
static SwigV8ReturnValue _wrap_new_ValueMetaDataKeySwig__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  ...
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_ValueMetaDataKeySwig__SWIG_0.");
  if(args.Length() < 2 || args.Length() > 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_ValueMetaDataKeySwig__SWIG_0.");
  {
    {
      std::string *ptr = (std::string *)0;
...
static SwigV8ReturnValue _wrap_new_ValueMetaDataKeySwig__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  ...
  int ecode3 = 0 ;
  ValueMetaDataKey *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_ValueMetaDataKeySwig__SWIG_1.");
  if(args.Length() < 3 || args.Length() > 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_ValueMetaDataKeySwig__SWIG_1.");
  {
    {
      std::string *ptr = (std::string *)0;
      int res = SWIG_AsPtr_std_string(args[0], &ptr);
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_ValueMetaDataKeySwig" "', argument " "2"" of type '" "unsigned char []""'"); 
  } 
  arg2 = reinterpret_cast< unsigned char * >(argp2);ecode3 = SWIG_AsVal_long(args[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "new_ValueMetaDataKeySwig" "', argument " "3"" of type '" "long""'");
  } 
...
static SwigV8ReturnValue _wrap_new_ValueMetaDataKeySwig(const SwigV8Arguments &args) {
  ...
  if(args.Length() == 2) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_ValueMetaDataKeySwig__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_ValueMetaDataKeySwig__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  if(args.Length() == 3) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_ValueMetaDataKeySwig__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_ValueMetaDataKeySwig__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  // default:
  SWIG_exception_fail(SWIG_ERROR, "Illegal arguments for construction of _exports_ValueMetaDataKeySwig");
...
static SwigV8ReturnValue _wrap_ValueMetaDataKeySwig_getPropertyName(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataKeySwig_getPropertyName.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ValueMetaDataKey, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_ValueMetaDataKeySwig_getValueName(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataKeySwig_getValueName.");
...
static SwigV8ReturnValue _wrap_ValueMetaDataSwig_getName(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataSwig_getName.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ValueMetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_ValueMetaDataSwig_getDescription(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataSwig_getDescription.");
...
static SwigV8ReturnValue _wrap_ValueMetaDataSwig_getUrl(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataSwig_getUrl.");
...
static SwigV8ReturnValue _wrap_ValueMetaDataSwig_getUtf8ValueName(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataSwig_getUtf8ValueName.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ValueMetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ValueMetaDataSwig_getUtf8ValueName" "', argument " "1"" of type '" "ValueMetaData *""'"); 
  }
  arg1 = reinterpret_cast< ValueMetaData * >(argp1);{
    try {
...
static SwigV8ReturnValue _wrap_ComponentMetaDataCollectionSwig_getByKey(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ComponentMetaDataCollectionSwig_getByKey.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_CollectionT_byte_ComponentMetaData_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< Collection< byte,ComponentMetaData > * >(argp1);{
    {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ComponentMetaDataCollectionSwig_getByKey" "', argument " "2"" of type '" "byte""'");
      } else {
...
static SwigV8ReturnValue _wrap_ComponentMetaDataCollectionSwig_getByIndex(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ComponentMetaDataCollectionSwig_getByIndex.");
  ...
  arg1 = reinterpret_cast< Collection< byte,ComponentMetaData > * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ComponentMetaDataCollectionSwig_getSize(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ComponentMetaDataCollectionSwig_getSize.");
...
static SwigV8ReturnValue _wrap_PropertyMetaDataCollectionSwig_getByKey(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataCollectionSwig_getByKey.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_CollectionT_std__string_PropertyMetaData_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_PropertyMetaDataCollectionSwig_getByIndex(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataCollectionSwig_getByIndex.");
  ...
  arg1 = reinterpret_cast< Collection< std::string,PropertyMetaData > * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_PropertyMetaDataCollectionSwig_getSize(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_PropertyMetaDataCollectionSwig_getSize.");
...
static SwigV8ReturnValue _wrap_ProfileMetaDataCollectionSwig_getByKey(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ProfileMetaDataCollectionSwig_getByKey.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_CollectionT_uint32_t_ProfileMetaData_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< Collection< uint32_t,ProfileMetaData > * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ProfileMetaDataCollectionSwig_getByKey" "', argument " "2"" of type '" "unsigned int""'");
  } 
...
static SwigV8ReturnValue _wrap_ProfileMetaDataCollectionSwig_getByIndex(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ProfileMetaDataCollectionSwig_getByIndex.");
...
static SwigV8ReturnValue _wrap_ProfileMetaDataCollectionSwig_getSize(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ProfileMetaDataCollectionSwig_getSize.");
...
static SwigV8ReturnValue _wrap_ValueMetaDataCollectionSwig_getByKey(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataCollectionSwig_getByKey.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_CollectionT_ValueMetaDataKey_ValueMetaData_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< Collection< ValueMetaDataKey,ValueMetaData > * >(argp1);{
    {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ValueMetaDataCollectionSwig_getByKey" "', argument " "2"" of type '" "ValueMetaDataKey""'");
      } else {
...
static SwigV8ReturnValue _wrap_ValueMetaDataCollectionSwig_getByIndex(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataCollectionSwig_getByIndex.");
  ...
  arg1 = reinterpret_cast< Collection< ValueMetaDataKey,ValueMetaData > * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ValueMetaDataCollectionSwig_getSize(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ValueMetaDataCollectionSwig_getSize.");
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getComponents(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getComponents.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_MetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getProperties(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getProperties.");
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getProfiles(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getProfiles.");
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getValues(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getValues.");
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getValuesForProperty(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getValuesForProperty.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_MetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MetaDataSwig_getValuesForProperty" "', argument " "1"" of type '" "MetaData *""'"); 
  }
  arg1 = reinterpret_cast< MetaData * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_PropertyMetaData, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getValuesForProfile(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getValuesForProfile.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_MetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MetaDataSwig_getValuesForProfile" "', argument " "1"" of type '" "MetaData *""'"); 
  }
  arg1 = reinterpret_cast< MetaData * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_ProfileMetaData, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getComponentForProfile(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getComponentForProfile.");
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getComponentForProperty(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getComponentForProperty.");
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getDefaultProfileForComponent(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getDefaultProfileForComponent.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_MetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MetaDataSwig_getDefaultProfileForComponent" "', argument " "1"" of type '" "MetaData *""'"); 
  }
  arg1 = reinterpret_cast< MetaData * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_ComponentMetaData, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getDefaultValueForProperty(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getDefaultValueForProperty.");
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getPropertiesForComponent(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getPropertiesForComponent.");
...
static SwigV8ReturnValue _wrap_MetaDataSwig_getPropertyForValue(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_MetaDataSwig_getPropertyForValue.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_MetaData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MetaDataSwig_getPropertyForValue" "', argument " "1"" of type '" "MetaData *""'"); 
  }
  arg1 = reinterpret_cast< MetaData * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_ValueMetaData, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_setLicenseKey(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_setLicenseKey.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_EngineBase, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< EngineBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "EngineBaseSwig_setLicenseKey" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_setDataUpdateUrl(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_setDataUpdateUrl.");
  ...
  arg1 = reinterpret_cast< EngineBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "EngineBaseSwig_setDataUpdateUrl" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getMetaData(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getMetaData.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getAutomaticUpdatesEnabled(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getAutomaticUpdatesEnabled.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_processBase(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_processBase.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_EngineBase, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "EngineBaseSwig_processBase" "', argument " "1"" of type '" "EngineBase *""'"); 
  }
  arg1 = reinterpret_cast< EngineBase * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_EvidenceBase, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_refreshData__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< EngineBase * >(argp1);res2 = SWIG_AsCharPtrAndSize(args[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_refreshData__SWIG_2(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< EngineBase * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_unsigned_char, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "EngineBaseSwig_refreshData" "', argument " "2"" of type '" "unsigned char []""'"); 
  } 
  arg2 = reinterpret_cast< unsigned char * >(argp2);ecode3 = SWIG_AsVal_long(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getDataUpdateUrl(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getDataUpdateUrl.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getPublishedTime(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getPublishedTime.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getUpdateAvailableTime(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getUpdateAvailableTime.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getDataFilePath(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getDataFilePath.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getDataFileTempPath(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getDataFileTempPath.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getProduct(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getProduct.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getType(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getType.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getKeys(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getKeys.");
...
static SwigV8ReturnValue _wrap_EngineBaseSwig_getIsThreadSafe(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineBaseSwig_getIsThreadSafe.");
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_setUseUpperPrefixHeaders(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_setUseUpperPrefixHeaders.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ConfigBase, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConfigBaseSwig_setUseUpperPrefixHeaders" "', argument " "1"" of type '" "ConfigBase *""'"); 
  }
  arg1 = reinterpret_cast< ConfigBase * >(argp1);ecode2 = SWIG_AsVal_bool(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_setUseTempFile(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_setUseTempFile.");
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_setReuseTempFile(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_setReuseTempFile.");
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_setTempDirectories(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_setTempDirectories.");
  ...
  arg1 = reinterpret_cast< ConfigBase * >(argp1);{
    {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "ConfigBaseSwig_setTempDirectories" "', argument " "2"" of type '" "std::vector< std::string >""'");
      } else {
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_getUseUpperPrefixHeaders(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_getUseUpperPrefixHeaders.");
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_getUseTempFile(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_getUseTempFile.");
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_getReuseTempFile(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_getReuseTempFile.");
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_getTempDirectories(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_getTempDirectories.");
...
static SwigV8ReturnValue _wrap_ConfigBaseSwig_getConcurrency(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigBaseSwig_getConcurrency.");
...
static SwigV8ReturnValue _wrap_ConfigDeviceDetectionSwig_setUpdateMatchedUserAgent(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigDeviceDetectionSwig_setUpdateMatchedUserAgent.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ConfigDeviceDetection, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< ConfigDeviceDetection * >(argp1);ecode2 = SWIG_AsVal_bool(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ConfigDeviceDetectionSwig_setMaxMatchedUserAgentLength(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigDeviceDetectionSwig_setMaxMatchedUserAgentLength.");
  ...
  arg1 = reinterpret_cast< ConfigDeviceDetection * >(argp1);ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ConfigDeviceDetectionSwig_setAllowUnmatched(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigDeviceDetectionSwig_setAllowUnmatched.");
...
static SwigV8ReturnValue _wrap_ConfigDeviceDetectionSwig_getUpdateMatchedUserAgent(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigDeviceDetectionSwig_getUpdateMatchedUserAgent.");
...
static SwigV8ReturnValue _wrap_ConfigDeviceDetectionSwig_getMaxMatchedUserAgentLength(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigDeviceDetectionSwig_getMaxMatchedUserAgentLength.");
...
static SwigV8ReturnValue _wrap_ConfigDeviceDetectionSwig_getAllowUnmatched(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigDeviceDetectionSwig_getAllowUnmatched.");
...
static SwigV8ReturnValue _wrap_new_EvidenceBaseSwig(const SwigV8Arguments &args) {
  ...
  SWIGV8_OBJECT self = args.This();
  EvidenceBase *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_EvidenceBaseSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_EvidenceBaseSwig.");
  {
    try {
...
static SwigV8ReturnValue _wrap_EvidenceBaseSwig_set(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 2 || args.Length() > 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EvidenceBaseSwig_set.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_EvidenceBase, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< EvidenceBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "EvidenceBaseSwig_set" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
  {
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "EvidenceBaseSwig_set" "', argument " "3"" of type '" "std::string const &""'"); 
      }
      arg3 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_EvidenceBaseSwig_get(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EvidenceBaseSwig_get.");
  ...
  arg1 = reinterpret_cast< EvidenceBase * >(argp1);{
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "EvidenceBaseSwig_get" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_EvidenceBaseSwig_size(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EvidenceBaseSwig_size.");
...
static SwigV8ReturnValue _wrap_new_EvidenceDeviceDetectionSwig(const SwigV8Arguments &args) {
  ...
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_EvidenceDeviceDetectionSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_EvidenceDeviceDetectionSwig.");
  {
    try {
  ...
  {
    {
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "EngineDeviceDetectionSwig_defaultElementDataKey_set" "', argument " "1"" of type '" "std::string const &""'"); 
      }
      arg1 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_EngineDeviceDetectionSwig_processDeviceDetection__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  SWIGV8_VALUE jsresult;
  EngineDeviceDetection *arg1 = 0 ;
  EvidenceDeviceDetection *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_EngineDeviceDetection, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< EngineDeviceDetection * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_EvidenceDeviceDetection, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_EngineDeviceDetectionSwig_processDeviceDetection__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< EngineDeviceDetection * >(argp1);res2 = SWIG_AsCharPtrAndSize(args[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_ResultsDeviceDetectionSwig_getDeviceId(const SwigV8Arguments &args) {
  ...
  SWIGV8_VALUE jsresult;
  ResultsDeviceDetection *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::string result;
  
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsDeviceDetectionSwig_getDeviceId.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ResultsDeviceDetection, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_ResultsDeviceDetectionSwig_getUserAgent(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsDeviceDetectionSwig_getUserAgent.");
  ...
  arg1 = reinterpret_cast< ResultsDeviceDetection * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ResultsDeviceDetectionSwig_getUserAgents(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsDeviceDetectionSwig_getUserAgents.");
...
static SwigV8ReturnValue _wrap_ResultsHashSwig_getDeviceId__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ResultsHash, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_ResultsHashSwig_getDeviceId__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< ResultsHash * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ResultsHashSwig_getTrace(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsHashSwig_getTrace.");
...
static SwigV8ReturnValue _wrap_ResultsHashSwig_getMatchedNodes(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsHashSwig_getMatchedNodes.");
...
static SwigV8ReturnValue _wrap_ResultsHashSwig_getIterations(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsHashSwig_getIterations.");
...
static SwigV8ReturnValue _wrap_ResultsHashSwig_getUserAgent(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsHashSwig_getUserAgent.");
...
static SwigV8ReturnValue _wrap_ResultsHashSwig_getUserAgents(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsHashSwig_getUserAgents.");
...
static SwigV8ReturnValue _wrap_new_CollectionConfigSwig(const SwigV8Arguments &args) {
  ...
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_CollectionConfigSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_CollectionConfigSwig.");
  {
    try {
...
static SwigV8ReturnValue _wrap_CollectionConfigSwig_setCapacity(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CollectionConfigSwig_setCapacity.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_CollectionConfig, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "CollectionConfigSwig_setCapacity" "', argument " "1"" of type '" "CollectionConfig *""'"); 
  }
  arg1 = reinterpret_cast< CollectionConfig * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_CollectionConfigSwig_setConcurrency(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CollectionConfigSwig_setConcurrency.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_CollectionConfig, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "CollectionConfigSwig_setConcurrency" "', argument " "1"" of type '" "CollectionConfig *""'"); 
  }
  arg1 = reinterpret_cast< CollectionConfig * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_short(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_CollectionConfigSwig_setLoaded(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CollectionConfigSwig_setLoaded.");
...
static SwigV8ReturnValue _wrap_CollectionConfigSwig_getCapacity(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CollectionConfigSwig_getCapacity.");
...
static SwigV8ReturnValue _wrap_CollectionConfigSwig_getConcurrency(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CollectionConfigSwig_getConcurrency.");
...
static SwigV8ReturnValue _wrap_CollectionConfigSwig_getLoaded(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_CollectionConfigSwig_getLoaded.");
...
static SwigV8ReturnValue _wrap_new_ConfigHashSwig(const SwigV8Arguments &args) {
  ...
  SWIGV8_OBJECT self = args.This();
  ConfigHash *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_ConfigHashSwig.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_ConfigHashSwig.");
  {
    try {
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setHighPerformance(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setHighPerformance.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ConfigHash, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setBalanced(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setBalanced.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setBalancedTemp(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setBalancedTemp.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setLowMemory(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setLowMemory.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setMaxPerformance(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setMaxPerformance.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setDrift(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setDrift.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ConfigHash, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConfigHashSwig_setDrift" "', argument " "1"" of type '" "ConfigHash *""'"); 
  }
  arg1 = reinterpret_cast< ConfigHash * >(argp1);ecode2 = SWIG_AsVal_int(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setDifference(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setDifference.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setConcurrency(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setConcurrency.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ConfigHash, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConfigHashSwig_setConcurrency" "', argument " "1"" of type '" "ConfigHash *""'"); 
  }
  arg1 = reinterpret_cast< ConfigHash * >(argp1);ecode2 = SWIG_AsVal_unsigned_SS_short(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setUsePerformanceGraph(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setUsePerformanceGraph.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ConfigHash, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConfigHashSwig_setUsePerformanceGraph" "', argument " "1"" of type '" "ConfigHash *""'"); 
  }
  arg1 = reinterpret_cast< ConfigHash * >(argp1);ecode2 = SWIG_AsVal_bool(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setUsePredictiveGraph(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setUsePredictiveGraph.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_setTraceRoute(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_setTraceRoute.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getStrings(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getStrings.");
  ...
  jsresult = SWIG_NewPointerObj((new CollectionConfig(result)), SWIGTYPE_p_CollectionConfig, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getProperties(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getProperties.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getValues(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getValues.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getProfiles(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getProfiles.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getNodes(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getNodes.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getProfileOffsets(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getProfileOffsets.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getDrift(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getDrift.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getDifference(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getDifference.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getUsePerformanceGraph(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getUsePerformanceGraph.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getUsePredictiveGraph(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getUsePredictiveGraph.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getConcurrency(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getConcurrency.");
...
static SwigV8ReturnValue _wrap_ConfigHashSwig_getTraceRoute(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ConfigHashSwig_getTraceRoute.");
...
static SwigV8ReturnValue _wrap_new_EngineHashSwig__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  int res3 = 0 ;
  EngineHash *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_EngineHashSwig__SWIG_0.");
  if(args.Length() < 3 || args.Length() > 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_EngineHashSwig__SWIG_0.");
  {
    {
      std::string *ptr = (std::string *)0;
      ...
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_EngineHashSwig" "', argument " "1"" of type '" "std::string const &""'"); 
      }
      arg1 = ptr;
    }
  }
  ...
  arg2 = reinterpret_cast< ConfigHash * >(argp2);res3 = SWIG_ConvertPtr(args[2], &argp3,SWIGTYPE_p_RequiredPropertiesConfig, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
...
static SwigV8ReturnValue _wrap_new_EngineHashSwig__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  ...
  int res4 = 0 ;
  EngineHash *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_EngineHashSwig__SWIG_1.");
  if(args.Length() < 4 || args.Length() > 4) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_EngineHashSwig__SWIG_1.");
  ...
  arg1 = reinterpret_cast< unsigned char * >(argp1);ecode2 = SWIG_AsVal_long(args[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "new_EngineHashSwig" "', argument " "2"" of type '" "long""'");
  } 
  arg2 = static_cast< long >(val2);res3 = SWIG_ConvertPtr(args[2], &argp3,SWIGTYPE_p_ConfigHash, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "new_EngineHashSwig" "', argument " "3"" of type '" "ConfigHash *""'"); 
  }
  arg3 = reinterpret_cast< ConfigHash * >(argp3);res4 = SWIG_ConvertPtr(args[3], &argp4,SWIGTYPE_p_RequiredPropertiesConfig, 0 |  0 );
  if (!SWIG_IsOK(res4)) {
...
static SwigV8ReturnValue _wrap_EngineHashSwig_getPublishedTime(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineHashSwig_getPublishedTime.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_EngineHash, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_EngineHashSwig_getUpdateAvailableTime(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineHashSwig_getUpdateAvailableTime.");
...
static SwigV8ReturnValue _wrap_EngineHashSwig_getDataFilePath(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineHashSwig_getDataFilePath.");
...
static SwigV8ReturnValue _wrap_EngineHashSwig_getDataFileTempPath(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineHashSwig_getDataFileTempPath.");
...
static SwigV8ReturnValue _wrap_EngineHashSwig_refreshData__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< EngineHash * >(argp1);res2 = SWIG_AsCharPtrAndSize(args[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_EngineHashSwig_refreshData__SWIG_2(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< EngineHash * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_unsigned_char, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_EngineHashSwig_process__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  ...
  arg1 = reinterpret_cast< EngineHash * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_EvidenceDeviceDetection, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_EngineHashSwig_processBase(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_EngineHashSwig_processBase.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_EngineHash, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "EngineHashSwig_processBase" "', argument " "1"" of type '" "EngineHash *""'"); 
  }
  arg1 = reinterpret_cast< EngineHash * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_EvidenceBase, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_new_ResultsHashSerializer__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.This();
  ResultsHashSerializer *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_ResultsHashSerializer__SWIG_0.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_ResultsHashSerializer__SWIG_0.");
  {
    try {
      result = (ResultsHashSerializer *)new ResultsHashSerializer();;
    }
    catch(FatalException& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
  ...
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_ResultsHashSerializer, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_new_ResultsHashSerializer__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  ...
  int ecode1 = 0 ;
  ResultsHashSerializer *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_ResultsHashSerializer__SWIG_1.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_ResultsHashSerializer__SWIG_1.");
  ecode1 = SWIG_AsVal_size_t(args[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_ResultsHashSerializer" "', argument " "1"" of type '" "std::size_t""'");
  } 
  arg1 = static_cast< std::size_t >(val1);{
    try {
      result = (ResultsHashSerializer *)new ResultsHashSerializer(SWIG_STD_MOVE(*(&arg1)));;
    }
    catch(FatalException& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
...
static SwigV8ReturnValue _wrap_new_ResultsHashSerializer(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() == 0) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_ResultsHashSerializer__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_ResultsHashSerializer__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_ResultsHashSerializer__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_ResultsHashSerializer__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  // default:
  SWIG_exception_fail(SWIG_ERROR, "Illegal arguments for construction of _exports_ResultsHashSerializer");
...
static SwigV8ReturnValue _wrap_ResultsHashSerializer_allValuesJson(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  ResultsHashSerializer *arg1 = 0 ;
  ResultsHash *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ResultsHashSerializer_allValuesJson.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_ResultsHashSerializer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ResultsHashSerializer_allValuesJson" "', argument " "1"" of type '" "ResultsHashSerializer *""'"); 
  }
  arg1 = reinterpret_cast< ResultsHashSerializer * >(argp1);res2 = SWIG_ConvertPtr(args[0], &argp2,SWIGTYPE_p_ResultsHash, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ResultsHashSerializer_allValuesJson" "', argument " "2"" of type '" "ResultsHash *""'"); 
  }
  arg2 = reinterpret_cast< ResultsHash * >(argp2);{
    try {
      result = (arg1)->allValuesJson(arg2);;
    }
    catch(FatalException& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
...
static void _wrap_delete_ResultsHashSerializer(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    ResultsHashSerializer * arg1 = (ResultsHashSerializer *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static SwigV8ReturnValue _wrap_new_Transform__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.This();
  Transform *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_Transform__SWIG_0.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Transform__SWIG_0.");
  {
    try {
  ...
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_Transform, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static SwigV8ReturnValue _wrap_new_Transform__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler) {
  SWIGV8_HANDLESCOPE();
  ...
  int ecode1 = 0 ;
  Transform *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_Transform__SWIG_1.");
  if(args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Transform__SWIG_1.");
  ecode1 = SWIG_AsVal_size_t(args[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_Transform" "', argument " "1"" of type '" "size_t""'");
  } 
  arg1 = static_cast< size_t >(val1);{
    try {
      result = (Transform *)new Transform(SWIG_STD_MOVE(*(&arg1)));;
    }
    catch(FatalException& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
...
static SwigV8ReturnValue _wrap_new_Transform(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() == 0) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_Transform__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_Transform__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (V8_MAJOR_VERSION-0) < 4 && (SWIG_V8_VERSION < 0x031903)
    self = _wrap_new_Transform__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(self);
    } else {
      goto fail;
...
#else
    _wrap_new_Transform__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    } else {
      goto fail;
  ...
  // default:
  SWIG_exception_fail(SWIG_ERROR, "Illegal arguments for construction of _exports_Transform");
...
static SwigV8ReturnValue _wrap_Transform_fromJsonGHEV(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Transform_fromJsonGHEV.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_Transform, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Transform_fromJsonGHEV" "', argument " "1"" of type '" "Transform *""'"); 
  }
  arg1 = reinterpret_cast< Transform * >(argp1);{
    {
      ...
      res2 = SWIG_AsPtr_std_string(args[0], &ptr);
      if (!SWIG_IsOK(res2)) {
        SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Transform_fromJsonGHEV" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Transform_fromJsonGHEV" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
  ...
  jsresult = SWIG_NewPointerObj((new std::map< std::string,std::string,std::less< std::string > >(result)), SWIGTYPE_p_std__mapT_std__string_std__string_t, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_Transform_fromBase64GHEV(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Transform_fromBase64GHEV.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_Transform, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Transform_fromBase64GHEV" "', argument " "1"" of type '" "Transform *""'"); 
  }
  arg1 = reinterpret_cast< Transform * >(argp1);{
    {
      std::string *ptr = (std::string *)0;
      res2 = SWIG_AsPtr_std_string(args[0], &ptr);
      if (!SWIG_IsOK(res2)) {
        SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Transform_fromBase64GHEV" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Transform_fromBase64GHEV" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static SwigV8ReturnValue _wrap_Transform_fromSUA(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Transform_fromSUA.");
  
  res1 = SWIG_ConvertPtr(args.This(), &argp1,SWIGTYPE_p_Transform, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Transform_fromSUA" "', argument " "1"" of type '" "Transform *""'"); 
  }
  arg1 = reinterpret_cast< Transform * >(argp1);{
    {
      std::string *ptr = (std::string *)0;
      res2 = SWIG_AsPtr_std_string(args[0], &ptr);
      if (!SWIG_IsOK(res2)) {
        SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Transform_fromSUA" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      if (!ptr) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Transform_fromSUA" "', argument " "2"" of type '" "std::string const &""'"); 
      }
      arg2 = ptr;
    }
  }
...
static void _wrap_delete_Transform(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    Transform * arg1 = (Transform *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static swig_type_info _swigt__p_CollectionConfig = {"_p_CollectionConfig", "p_CollectionConfig|CollectionConfig *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_CollectionT_uint32_t_ProfileMetaData_t = {"_p_CollectionT_uint32_t_ProfileMetaData_t", "Collection< uint32_t,ProfileMetaData > *|Collection< unsigned int,ProfileMetaData > *|p_CollectionT_uint32_t_ProfileMetaData_t", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ComponentMetaData = {"_p_ComponentMetaData", "p_ComponentMetaData|ComponentMetaData *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ConfigBase = {"_p_ConfigBase", "p_ConfigBase|ConfigBase *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ConfigDeviceDetection = {"_p_ConfigDeviceDetection", "p_ConfigDeviceDetection|ConfigDeviceDetection *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ConfigHash = {"_p_ConfigHash", "ConfigHash *|p_ConfigHash", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_MetaData = {"_p_MetaData", "p_MetaData|MetaData *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ProfileMetaData = {"_p_ProfileMetaData", "p_ProfileMetaData|ProfileMetaData *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_PropertyMetaData = {"_p_PropertyMetaData", "p_PropertyMetaData|PropertyMetaData *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_RequiredPropertiesConfig = {"_p_RequiredPropertiesConfig", "p_RequiredPropertiesConfig|RequiredPropertiesConfig *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ResultsBase = {"_p_ResultsBase", "ResultsBase *|p_ResultsBase", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ResultsDeviceDetection = {"_p_ResultsDeviceDetection", "p_ResultsDeviceDetection|ResultsDeviceDetection *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ResultsHash = {"_p_ResultsHash", "ResultsHash *|p_ResultsHash", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ResultsHashSerializer = {"_p_ResultsHashSerializer", "ResultsHashSerializer *|p_ResultsHashSerializer", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Transform = {"_p_Transform", "p_Transform|Transform *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ValueMetaData = {"_p_ValueMetaData", "ValueMetaData *|p_ValueMetaData", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ValueMetaDataKey = {"_p_ValueMetaDataKey", "ValueMetaDataKey *|p_ValueMetaDataKey", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ValueT_bool_t = {"_p_ValueT_bool_t", "p_ValueT_bool_t|Value< bool > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ValueT_double_t = {"_p_ValueT_double_t", "Value< double > *|p_ValueT_double_t", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ValueT_int_t = {"_p_ValueT_int_t", "p_ValueT_int_t|Value< int > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ValueT_std__string_t = {"_p_ValueT_std__string_t", "Value< std::string > *|p_ValueT_std__string_t", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_ResultsHashSerializer,
  &_swigt__p_Transform,
...
static swig_cast_info _swigc__p_ConfigBase[] = {  {&_swigt__p_ConfigBase, 0, 0, 0},  {&_swigt__p_ConfigDeviceDetection, _p_ConfigDeviceDetectionTo_p_ConfigBase, 0, 0},  {&_swigt__p_ConfigHash, _p_ConfigHashTo_p_ConfigBase, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ConfigDeviceDetection[] = {  {&_swigt__p_ConfigDeviceDetection, 0, 0, 0},  {&_swigt__p_ConfigHash, _p_ConfigHashTo_p_ConfigDeviceDetection, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_EngineBase[] = {  {&_swigt__p_EngineBase, 0, 0, 0},  {&_swigt__p_EngineDeviceDetection, _p_EngineDeviceDetectionTo_p_EngineBase, 0, 0},  {&_swigt__p_EngineHash, _p_EngineHashTo_p_EngineBase, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_EngineDeviceDetection[] = {  {&_swigt__p_EngineDeviceDetection, 0, 0, 0},  {&_swigt__p_EngineHash, _p_EngineHashTo_p_EngineDeviceDetection, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_ResultsBase[] = {  {&_swigt__p_ResultsBase, 0, 0, 0},  {&_swigt__p_ResultsDeviceDetection, _p_ResultsDeviceDetectionTo_p_ResultsBase, 0, 0},  {&_swigt__p_ResultsHash, _p_ResultsHashTo_p_ResultsBase, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ResultsDeviceDetection[] = {  {&_swigt__p_ResultsDeviceDetection, 0, 0, 0},  {&_swigt__p_ResultsHash, _p_ResultsHashTo_p_ResultsDeviceDetection, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ResultsHash[] = {  {&_swigt__p_ResultsHash, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ResultsHashSerializer[] = {  {&_swigt__p_ResultsHashSerializer, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__mapT_std__string_std__string_t[] = {  {&_swigt__p_std__mapT_std__string_std__string_t, 0, 0, 0},  {&_swigt__p_EvidenceBase, _p_EvidenceBaseTo_p_std__mapT_std__string_std__string_t, 0, 0},  {&_swigt__p_EvidenceDeviceDetection, _p_EvidenceDeviceDetectionTo_p_std__mapT_std__string_std__string_t, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_ResultsHashSerializer,
  _swigc__p_Transform,
...
#endif
{
  ...
  /* Name: _exports_MapStringStringSwig, Type: p_std__mapT_std__string_std__string_t, Dtor: _wrap_delete_MapStringStringSwig */
...
if (SWIGTYPE_p_std__mapT_std__string_std__string_t->clientdata == 0) {
  SWIGTYPE_p_std__mapT_std__string_std__string_t->clientdata = &_exports_MapStringStringSwig_clientData;
}
...
/* Name: _exports_UTF8StringSwig, Type: p_std__vectorT_uint8_t_t, Dtor: _wrap_delete_UTF8StringSwig */
SWIGV8_FUNCTION_TEMPLATE _exports_UTF8StringSwig_class = SWIGV8_CreateClassTemplate("_exports_UTF8StringSwig");
SWIGV8_SET_CLASS_TEMPL(_exports_UTF8StringSwig_clientData.class_templ, _exports_UTF8StringSwig_class);
_exports_UTF8StringSwig_clientData.dtor = _wrap_delete_UTF8StringSwig;
if (SWIGTYPE_p_std__vectorT_uint8_t_t->clientdata == 0) {
  SWIGTYPE_p_std__vectorT_uint8_t_t->clientdata = &_exports_UTF8StringSwig_clientData;
}
...
/* Name: _exports_ResultsHashSerializer, Type: p_ResultsHashSerializer, Dtor: _wrap_delete_ResultsHashSerializer */
SWIGV8_FUNCTION_TEMPLATE _exports_ResultsHashSerializer_class = SWIGV8_CreateClassTemplate("_exports_ResultsHashSerializer");
SWIGV8_SET_CLASS_TEMPL(_exports_ResultsHashSerializer_clientData.class_templ, _exports_ResultsHashSerializer_class);
_exports_ResultsHashSerializer_clientData.dtor = _wrap_delete_ResultsHashSerializer;
if (SWIGTYPE_p_ResultsHashSerializer->clientdata == 0) {
  SWIGTYPE_p_ResultsHashSerializer->clientdata = &_exports_ResultsHashSerializer_clientData;
}
/* Name: _exports_Transform, Type: p_Transform, Dtor: _wrap_delete_Transform */
SWIGV8_FUNCTION_TEMPLATE _exports_Transform_class = SWIGV8_CreateClassTemplate("_exports_Transform");
SWIGV8_SET_CLASS_TEMPL(_exports_Transform_clientData.class_templ, _exports_Transform_class);
_exports_Transform_clientData.dtor = _wrap_delete_Transform;
if (SWIGTYPE_p_Transform->clientdata == 0) {
  SWIGTYPE_p_Transform->clientdata = &_exports_Transform_clientData;
}
...
SWIGV8_AddMemberFunction(_exports_UTF8StringSwig_class, "size", _wrap_UTF8StringSwig_size);
SWIGV8_AddMemberFunction(_exports_UTF8StringSwig_class, "capacity", _wrap_UTF8StringSwig_capacity);
SWIGV8_AddMemberFunction(_exports_UTF8StringSwig_class, "reserve", _wrap_UTF8StringSwig_reserve);
SWIGV8_AddMemberFunction(_exports_UTF8StringSwig_class, "isEmpty", _wrap_UTF8StringSwig_isEmpty);
SWIGV8_AddMemberFunction(_exports_UTF8StringSwig_class, "clear", _wrap_UTF8StringSwig_clear);
SWIGV8_AddMemberFunction(_exports_UTF8StringSwig_class, "add", _wrap_UTF8StringSwig_add);
SWIGV8_AddMemberFunction(_exports_UTF8StringSwig_class, "get", _wrap_UTF8StringSwig_get);
SWIGV8_AddMemberFunction(_exports_UTF8StringSwig_class, "set", _wrap_UTF8StringSwig_set);
...
SWIGV8_AddMemberFunction(_exports_ValueMetaDataSwig_class, "getUtf8ValueName", _wrap_ValueMetaDataSwig_getUtf8ValueName);
...
SWIGV8_AddMemberFunction(_exports_ResultsHashSerializer_class, "allValuesJson", _wrap_ResultsHashSerializer_allValuesJson);
SWIGV8_AddMemberFunction(_exports_Transform_class, "fromJsonGHEV", _wrap_Transform_fromJsonGHEV);
SWIGV8_AddMemberFunction(_exports_Transform_class, "fromBase64GHEV", _wrap_Transform_fromBase64GHEV);
SWIGV8_AddMemberFunction(_exports_Transform_class, "fromSUA", _wrap_Transform_fromSUA);
...
if (SWIGTYPE_p_std__mapT_std__string_std__string_t->clientdata && !(static_cast<SWIGV8_ClientData *>(SWIGTYPE_p_std__mapT_std__string_std__string_t->clientdata)->class_templ.IsEmpty()))
{
  _exports_EvidenceBaseSwig_class->Inherit(
    v8::Local<v8::FunctionTemplate>::New(
      v8::Isolate::GetCurrent(),
      static_cast<SWIGV8_ClientData *>(SWIGTYPE_p_std__mapT_std__string_std__string_t->clientdata)->class_templ)
    );
  
#ifdef SWIGRUNTIME_DEBUG
  printf("Inheritance successful _exports_EvidenceBaseSwig _std__mapT_std__string_std__string_t\n");
#endif
} else {
#ifdef SWIGRUNTIME_DEBUG
  printf("Unable to inherit baseclass, it didn't exist _exports_EvidenceBaseSwig _std__mapT_std__string_std__string_t\n");
#endif
}
...
v8::Local<v8::Object> _exports_MapStringStringSwig_obj = _exports_MapStringStringSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_VectorStringSwig_obj = _exports_VectorStringSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_RequiredPropertiesConfigSwig_obj = _exports_RequiredPropertiesConfigSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_StringValueSwig_obj = _exports_StringValueSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_BoolValueSwig_obj = _exports_BoolValueSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_IntegerValueSwig_obj = _exports_IntegerValueSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_VectorStringValuesSwig_obj = _exports_VectorStringValuesSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_DoubleValueSwig_obj = _exports_DoubleValueSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ResultsBaseSwig_obj = _exports_ResultsBaseSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_PropertyMetaDataSwig_obj = _exports_PropertyMetaDataSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ComponentMetaDataSwig_obj = _exports_ComponentMetaDataSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ProfileMetaDataSwig_obj = _exports_ProfileMetaDataSwig_class_0->GetFunction(context).ToLocalChecked();
/* Class: UTF8StringSwig (_exports_UTF8StringSwig) */
SWIGV8_FUNCTION_TEMPLATE _exports_UTF8StringSwig_class_0 = SWIGV8_CreateClassTemplate("UTF8StringSwig");
_exports_UTF8StringSwig_class_0->SetCallHandler(_wrap_new_UTF8StringSwig);
_exports_UTF8StringSwig_class_0->Inherit(_exports_UTF8StringSwig_class);
v8::Local<v8::Object> _exports_UTF8StringSwig_obj = _exports_UTF8StringSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ValueMetaDataKeySwig_obj = _exports_ValueMetaDataKeySwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ValueMetaDataSwig_obj = _exports_ValueMetaDataSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ComponentMetaDataCollectionSwig_obj = _exports_ComponentMetaDataCollectionSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_PropertyMetaDataCollectionSwig_obj = _exports_PropertyMetaDataCollectionSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ProfileMetaDataCollectionSwig_obj = _exports_ProfileMetaDataCollectionSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ValueMetaDataCollectionSwig_obj = _exports_ValueMetaDataCollectionSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_MetaDataSwig_obj = _exports_MetaDataSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_EngineBaseSwig_obj = _exports_EngineBaseSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ConfigBaseSwig_obj = _exports_ConfigBaseSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ConfigDeviceDetectionSwig_obj = _exports_ConfigDeviceDetectionSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_EvidenceBaseSwig_obj = _exports_EvidenceBaseSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_EvidenceDeviceDetectionSwig_obj = _exports_EvidenceDeviceDetectionSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_EngineDeviceDetectionSwig_obj = _exports_EngineDeviceDetectionSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ResultsDeviceDetectionSwig_obj = _exports_ResultsDeviceDetectionSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ResultsHashSwig_obj = _exports_ResultsHashSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_CollectionConfigSwig_obj = _exports_CollectionConfigSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_ConfigHashSwig_obj = _exports_ConfigHashSwig_class_0->GetFunction(context).ToLocalChecked();
...
v8::Local<v8::Object> _exports_EngineHashSwig_obj = _exports_EngineHashSwig_class_0->GetFunction(context).ToLocalChecked();
/* Class: ResultsHashSerializer (_exports_ResultsHashSerializer) */
SWIGV8_FUNCTION_TEMPLATE _exports_ResultsHashSerializer_class_0 = SWIGV8_CreateClassTemplate("ResultsHashSerializer");
_exports_ResultsHashSerializer_class_0->SetCallHandler(_wrap_new_ResultsHashSerializer);
_exports_ResultsHashSerializer_class_0->Inherit(_exports_ResultsHashSerializer_class);
v8::Local<v8::Object> _exports_ResultsHashSerializer_obj = _exports_ResultsHashSerializer_class_0->GetFunction(context).ToLocalChecked();
/* Class: Transform (_exports_Transform) */
SWIGV8_FUNCTION_TEMPLATE _exports_Transform_class_0 = SWIGV8_CreateClassTemplate("Transform");
_exports_Transform_class_0->SetCallHandler(_wrap_new_Transform);
_exports_Transform_class_0->Inherit(_exports_Transform_class);
v8::Local<v8::Object> _exports_Transform_obj = _exports_Transform_class_0->GetFunction(context).ToLocalChecked();


  /* add static class functions and variables */
  SWIGV8_AddStaticVariable(_exports_EngineDeviceDetectionSwig_obj, "defaultElementDataKey", _wrap_EngineDeviceDetectionSwig_defaultElementDataKey_get, _wrap_EngineDeviceDetectionSwig_defaultElementDataKey_set, context);


  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("MapStringStringSwig"), _exports_MapStringStringSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("VectorStringSwig"), _exports_VectorStringSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("RequiredPropertiesConfigSwig"), _exports_RequiredPropertiesConfigSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("StringValueSwig"), _exports_StringValueSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("BoolValueSwig"), _exports_BoolValueSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("IntegerValueSwig"), _exports_IntegerValueSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("VectorStringValuesSwig"), _exports_VectorStringValuesSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("DoubleValueSwig"), _exports_DoubleValueSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ResultsBaseSwig"), _exports_ResultsBaseSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("Date"), _exports_Date_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("PropertyMetaDataSwig"), _exports_PropertyMetaDataSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ComponentMetaDataSwig"), _exports_ComponentMetaDataSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ProfileMetaDataSwig"), _exports_ProfileMetaDataSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("UTF8StringSwig"), _exports_UTF8StringSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ValueMetaDataKeySwig"), _exports_ValueMetaDataKeySwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ValueMetaDataSwig"), _exports_ValueMetaDataSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ComponentMetaDataCollectionSwig"), _exports_ComponentMetaDataCollectionSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("PropertyMetaDataCollectionSwig"), _exports_PropertyMetaDataCollectionSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ProfileMetaDataCollectionSwig"), _exports_ProfileMetaDataCollectionSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ValueMetaDataCollectionSwig"), _exports_ValueMetaDataCollectionSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("MetaDataSwig"), _exports_MetaDataSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("EngineBaseSwig"), _exports_EngineBaseSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ConfigBaseSwig"), _exports_ConfigBaseSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ConfigDeviceDetectionSwig"), _exports_ConfigDeviceDetectionSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("EvidenceBaseSwig"), _exports_EvidenceBaseSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("EvidenceDeviceDetectionSwig"), _exports_EvidenceDeviceDetectionSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("EngineDeviceDetectionSwig"), _exports_EngineDeviceDetectionSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ResultsDeviceDetectionSwig"), _exports_ResultsDeviceDetectionSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ResultsHashSwig"), _exports_ResultsHashSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("CollectionConfigSwig"), _exports_CollectionConfigSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ConfigHashSwig"), _exports_ConfigHashSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("EngineHashSwig"), _exports_EngineHashSwig_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("ResultsHashSerializer"), _exports_ResultsHashSerializer_obj));
SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("Transform"), _exports_Transform_obj));
...
#else
NODE_MODULE_CONTEXT_AWARE(DeviceDetectionHashEngineModule, DeviceDetectionHashEngineModule_initialize)
#endif
#endif
