...
static SwigV8ReturnValue _wrap_UTF8StringSwig_size(const SwigV8Arguments &args) {
  ...
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_std__vectorT_uint8_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_ResultsHashSerializer_allValuesJson(const SwigV8Arguments &args) {
  ...
  SWIGV8_VALUE jsresult;
  ResultsHashSerializer *arg1 = (ResultsHashSerializer *) 0 ;
  ResultsHash *arg2 = (ResultsHash *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_ResultsHashSerializer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_Transform_fromJsonGHEV(const SwigV8Arguments &args) {
  ...
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Transform, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
