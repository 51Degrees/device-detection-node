...
let corruptedUA = 'Mozilla/5.0 (iPhone; CPU iPhone OS 11_2 like Mac OS X) xAppleWebKit/604.4.7 (KHTML, like Gecko) Mobile/15C114';
...
flowData3.process().then(function () {
    console.info('User-Agent = ' + corruptedUA + '\nIsMobile = ' + flowData2.device.ismobile);
});